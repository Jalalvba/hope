...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="fixed top-4 right-4 z-40 w-8 h-8 rounded-full glass-subtle flex items-center justify-center text-sm text-gold-400 hover:bg-gold-400/15 transition-colors"
    >
      {ICON[current]}
    </button>
  );
